...
namespace AppDeipesaAPI.Controllers
{
    ...
    public class ClientesController : ControllerBase
    {
        ...
        public ClientesController(InventarioDeipesaContext context)
        {
            _context = context;
        }
        ...
        public async Task<ActionResult<Cliente>> PostCliente(Cliente cliente)
        {
          if (_context.Clientes == null)
          {
              return Problem("Entity set 'InventarioDeipesaContext.Clientes'  is null.");
          }
        ...
        public async Task<ActionResult<IEnumerable<Cliente>>> GetByCity(long cityId)
        {
            var result = await _context.Clientes
                .Include(cl => cl.Ciudad)
                .Where(cl => cl.Ciudad!.Id == cityId)
                .AsNoTracking()
                .AsSplitQuery()
                .ToListAsync();
